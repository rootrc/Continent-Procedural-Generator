...
ttk.Label(root, text = "Continent Procedural Generator", font = ("Segoe UI", 16, "bold")).pack(pady=10)
...
ttk.Button(root, text = "Generate World", command = generate).pack(pady=20)
